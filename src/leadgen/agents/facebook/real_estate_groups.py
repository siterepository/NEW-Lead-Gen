"""
Facebook Utah Real Estate Professional Groups Agent

Finds public Utah real estate professional Facebook groups using Google search.
Real estate professionals often have the sales skills, networking mindset, and
financial knowledge that make them strong NWM recruiting prospects.
...
GOOGLE_SEARCH_QUERIES: list[str] = [
    'site:facebook.com/groups "utah" "real estate"',
    'site:facebook.com/groups "utah" "realtor"',
    'site:facebook.com/groups "utah" "real estate agents"',
    'site:facebook.com/groups "utah" "real estate investors"',
    'site:facebook.com/groups "salt lake" "real estate"',
    'site:facebook.com/groups "utah county" "real estate"',
    'site:facebook.com/groups "utah" "property" "investing"',
    'site:facebook.com/groups "utah" "mortgage" "professionals"',
    'site:facebook.com/groups "utah" "real estate networking"',
]


class FBRealEstateGroupsAgent(BaseAgent):
    """Find public Utah real estate professional Facebook groups.

    Real estate professionals have transferable skills for financial
    services -- sales ability, client relationships, and financial acumen.
    """

    def __init__(self, config: dict[str, Any], db: Any) -> None:
        super().__init__(
            name="fb_real_estate_groups",
            platform="facebook",
            config=config,
            db=db,
        )
    ...
    def parse_item(self, raw_data: dict) -> dict:
        return {
            ...
            "platform": "facebook",
            "group_type": raw_data.get("group_type", "real_estate"),
