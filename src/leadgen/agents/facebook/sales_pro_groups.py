"""
Facebook Utah Sales Professional Groups Agent

Finds public Utah sales professional Facebook groups using Google search.
Sales professionals have highly transferable skills for NWM financial advisor
roles -- client relationship management, prospecting, and persuasion.
...
GOOGLE_SEARCH_QUERIES: list[str] = [
    'site:facebook.com/groups "utah" "sales professionals"',
    'site:facebook.com/groups "utah" "sales" "networking"',
    'site:facebook.com/groups "utah" "sales career"',
    'site:facebook.com/groups "utah" "sales reps"',
    'site:facebook.com/groups "salt lake" "sales"',
    'site:facebook.com/groups "utah" "B2B sales"',
    'site:facebook.com/groups "utah" "insurance sales"',
    'site:facebook.com/groups "utah" "financial sales"',
    'site:facebook.com/groups "utah" "account executive"',
]


class FBSalesProGroupsAgent(BaseAgent):
    """Find public Utah sales professional Facebook groups.

    Sales professionals have directly transferable skills for financial
    services careers -- prospecting, closing, and client management.
    """

    def __init__(self, config: dict[str, Any], db: Any) -> None:
        super().__init__(
            name="fb_sales_pro_groups",
            platform="facebook",
            config=config,
            db=db,
        )
    ...
    def parse_item(self, raw_data: dict) -> dict:
        return {
            ...
            "platform": "facebook",
            "group_type": raw_data.get("group_type", "sales_professional"),
