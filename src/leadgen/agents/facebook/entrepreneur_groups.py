"""
Facebook Utah Entrepreneur Groups Agent

Finds public Utah entrepreneur/startup Facebook groups using Google search.
Entrepreneurs and startup founders may be strong NWM recruiting prospects
due to their business mindset, networking orientation, and financial needs.
...
GOOGLE_SEARCH_QUERIES: list[str] = [
    'site:facebook.com/groups "utah" "entrepreneur"',
    'site:facebook.com/groups "utah" "startup"',
    'site:facebook.com/groups "utah" "small business"',
    'site:facebook.com/groups "salt lake" "entrepreneur"',
    'site:facebook.com/groups "utah" "business owners"',
    'site:facebook.com/groups "utah" "founders"',
    'site:facebook.com/groups "silicon slopes" "entrepreneur"',
    'site:facebook.com/groups "utah" "side hustle"',
    'site:facebook.com/groups "utah" "business networking"',
]


class FBEntrepreneurGroupsAgent(BaseAgent):
    """Find public Utah entrepreneur/startup Facebook groups.

    Discovers groups where entrepreneurs and startup founders gather,
    which are fertile ground for NWM recruiting prospects.
    """

    def __init__(self, config: dict[str, Any], db: Any) -> None:
        super().__init__(
            name="fb_entrepreneur_groups",
            platform="facebook",
            config=config,
            db=db,
        )
    ...
    def parse_item(self, raw_data: dict) -> dict:
        return {
            ...
            "platform": "facebook",
            "group_type": raw_data.get("group_type", "entrepreneur"),
